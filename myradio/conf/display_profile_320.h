...
#define UI_FONT_LABEL    20   // small labels (e.g. "Állomás")
#define UI_FONT_STREAM   20   // stream info line
#define UI_FONT_STATION  24   // station name sprite
#define UI_FONT_ARTIST   24   // artist sprite
#define UI_FONT_TITLE    20   // song title sprite
#define UI_FONT_VOLUME   20   // bottom bar volume value
