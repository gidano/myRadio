...
<ul>
  ...
  <li>Írd be a használni kívánt SSID/jelszó páros(oka)t (max. 5) <a href="https://github.com/gidano/myRadio/blob/main/binary%20files/SPIFSS%20upload.md">a leírás szerint</>a</li>
</ul>
