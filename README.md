...
<p align="center">
  <!-- 
  -->
  <img src="https://img.shields.io/github/downloads/gidano/myRadio/latest/total?style=for-the-badge&cacheSeconds=60" alt="Downloads">
...
<p align="center">
  ...
  <img src="https://github.com/gidano/myRadio/blob/main/tools/myRadio_Editor_fel%C3%BClet.jpg" alt="myRadio Editor" width="720" height="">
</p>
...
<ul>
  ...
  <li>Elkészült hozzá egy állomás lista kezelő szoftver, amely beolvassa/konvertálja a yoRadio-féle playlist.csv fájlt Yoradio-ról és PC-ről is</li>
  <li>..folyt. köv.</li>
</ul>
