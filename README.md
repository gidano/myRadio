...
- Arduino IDE 2.3.8 - CORE 3.3.7 - (magas bitrátájú adatfolyamok lejátszása csak a megfelelő [**liblwip módosítások elvégezése**](https://github.com/gidano/myRadio/Audio_IDF_Mod/Playing_high-bitrate_stations.pdf) után! / high bitrate stream playback only after applying the necessary liblwip modifications!)
